...
public final class AddEditAlarmFragment extends Fragment {
    ...
    public static androidx.fragment.app.Fragment newInstance(Alarm alarm) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mLabel.setOnTouchListener(mTouchListener);
        mMon.setOnTouchListener(mTouchListener);
        mTues.setOnTouchListener(mTouchListener);
        mWed.setOnTouchListener(mTouchListener);
        mThurs.setOnTouchListener(mTouchListener);
        mFri.setOnTouchListener(mTouchListener);
        mSat.setOnTouchListener(mTouchListener);
        mSun.setOnTouchListener(mTouchListener);
    ...
    public boolean hasAlarmChanged() {return mAlarmChanged;}
